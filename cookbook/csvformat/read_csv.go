...
// Movie will hold your parsed CSV
type Movie struct {
	Title    string
	Director string
	Year     int
...
func AddMoviesFromText() error {
	// this is an example of us taking a string, converting it into a buffer,
	// and reading it with the csv package
	// this is an example of us taking a string, converting // it into a buffer, and reading it
