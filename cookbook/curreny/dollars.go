...
// ConvertStringDollarsToPennies takes a dollar amount as a string,
// i.e. 1.00, 55.12 etc and converts it into an int64
func ConvertStringDollarsToPennies(amount string) (int64, error) {
	...
	// if there is no . result will still be captured here
	result := groups[0]
	// base string
	r := ""
