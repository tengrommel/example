...
// New method initialises with Order with priority,
// quantity, product, customerName
/**
The New method on the Order class assigns the properties the priority,
quantity, and product parameters for name and customerName.
*/
